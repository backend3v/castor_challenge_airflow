...
from sqlalchemy import BigInteger, Column, DateTime, Integer, MetaData, Numeric, String, Table, func, text
...
from pipeline.utils.exceptions import LoadError
from pipeline.utils.log import configure_logging, get_logger
from pipeline.infrastructure.resilience.checkpoint import update_checkpoint_after_chunk
...
FINANCIAL_RECORDS = Table(
    "financial_records",
    _METADATA,
    Column("transaction_id", BigInteger(), primary_key=True, nullable=False),
